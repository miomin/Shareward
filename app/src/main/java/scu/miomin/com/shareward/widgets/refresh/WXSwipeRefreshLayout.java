...
public class WXSwipeRefreshLayout extends FrameLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mPullRefreshEnable = ta.getBoolean(R.styleable.WXSwipeRefreshLayout_pull_refresh_enable, true);
        mPullLoadEnable = ta.getBoolean(R.styleable.WXSwipeRefreshLayout_pull_load_enable, true);
