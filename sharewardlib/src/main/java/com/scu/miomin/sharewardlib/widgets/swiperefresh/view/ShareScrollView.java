package com.scu.miomin.sharewardlib.widgets.swiperefresh.view;
...
public class ShareScrollView extends ScrollView implements NestedScrollingChild {
    ...
    public ShareScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShareScrollView(Context context, AttributeSet attrs, int defStyle) {
