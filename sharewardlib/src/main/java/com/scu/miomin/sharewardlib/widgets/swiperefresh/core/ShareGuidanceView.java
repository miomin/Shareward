...
import com.scu.miomin.sharewardlib.util.DipUtils;
import com.scu.miomin.sharewardlib.widgets.swiperefresh.drawable.CircleProgressBar;


/**
 * Created by 莫绪旻 on 16/6/24.
 */
public class ShareGuidanceView extends LinearLayout {

    private static final int DEFAULT_CIRCLE_SIZE = 36;
    private CircleProgressBar circleProgressBar;
    private TextView tvLoad;

    public ShareGuidanceView(Context context) {
        super(context);
        setupViews();
    }

    public ShareGuidanceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupViews();
    }

    public ShareGuidanceView(Context context, AttributeSet attrs, int defStyleAttr) {
